<div class="table-responsive">
    <table id="form-center" class="table table-bordered display cell-border ">
        <thead>
            <tr>
        ...
        <tbody>
            @foreach ($categories as $category)
                <tr>
                    ...
                    <td class="text-center d-flex flex-direction-row justify-content-center">
                        ...
                        <button class="text-center fs-6 btn btn-danger" data-toggle="modal"
