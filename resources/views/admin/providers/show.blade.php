...
<div class="container-fluid w-100">
    ...
    <div class="row p-3 bg-white border d-flex justify-content-center p-2">

        <div class="row my-3 xs-flex-column md-flex-row">
            ...
            <div class="col-lg-8">
                <div class="row d-flex flex-column align-items-center">
                    ...
                    <div class="row p-3 w-100">
                        ...
                        <div class="col-12 col-lg-6 info-provider">
                            ...
                            <div class="d-flex align-items-start flex-column flex-wrap mt-2">
                                ...
                                <p class="text-center lead mt-2">{{ $provider->name }}</p>
                            </div>
                            ...
                            <div class="d-flex align-items-start flex-column flex-wrap mt-2">
                                ...
                                <p class="text-center lead mt-2">{{ $provider->cuil_number }}</p>
                            </div>

                        </div>

                        <div class="col-12 col-md-6 info-provider">

                            <div class="d-flex align-items-start flex-column flex-wrap mt-2 w-100">
                                <div class="d-flex justify-content-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                        fill="currentColor" class="bi bi-envelope-at align-self-center mr-3"
                                        viewBox="0 0 16 16">
                                        <path
                                ...
                                <p class="text-center lead mt-2">{{ $provider->email }}</p>
                            </div>

                            <div class="d-flex align-items-start flex-column flex-wrap mt-2 w-100">
                                <div class="d-flex justify-content-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                        fill="currentColor" class="bi bi-geo-alt-fill align-self-center mr-3"
                                        viewBox="0 0 16 16">
                                        <path
                                ...
                                <p class="text-center lead mt-2">{{ $provider->adress }}</p>
                            </div>
                            ...
                            <div class="d-flex align-items-start flex-column flex-wrap mt-2 w-100">
                                ...
                                <p class="text-center lead mt-2">{{ $provider->phone }}</p>
                            </div>
                        </div>
                    </div>
                </div>
