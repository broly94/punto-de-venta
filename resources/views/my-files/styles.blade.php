...
{{-- <link rel="stylesheet" href="{{ asset('https://cdn.datatables.net/buttons/2.3.2/css/buttons.dataTables.min.css') }}"> 
{{-- <link rel="stylesheet" href="{{ asset('https://cdn.datatables.net/colreorder/1.6.1/css/colReorder.dataTables.min.css') }}"> 
{{-- <link rel="stylesheet" href="{{ asset('sweetalert/sweetalert2.min.css') }}"> --}}
{{-- <link href="{{ asset('https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css') }}" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous"> --}}
