          ...
          <ul class="nav mt-5 pt-5">
              ...
              <li class="nav-item">
                  <a class="nav-link" href="{{ route('categories.index') }}">
                      ...
                      <span class="menu-title fs-5">Categorias</span>
                  </a>
              </li>
              <li class="nav-item">
                  <a class="nav-link" href="{{ route('providers.index') }}">
                      ...
                      <span class="menu-title fs-5 ">Proveedores</span>
                  </a>
              </li>
              <li class="nav-item">
                  <a class="nav-link" href="{{ route('products.index') }}">
                      ...
                      <span class="menu-title fs-5 ">Productos</span>
                  </a>
              </li>
              <li class="nav-item">
                  <a class="nav-link" href="{{ route('clients.index') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-people-fill mr-4" viewBox="0 0 16 16">
                      ...
                      <span class="menu-title fs-5 ">Clientes</span>
                  </a>
              </li>
              <li class="nav-item">
                  <a class="nav-link" href="{{ route('purchases.index') }}">
                      ...
                      <span class="menu-title fs-5 ">Compras</span>
                  </a>
              </li>
              <li class="nav-item">
                  <a class="nav-link" href="{{ route('sales.index') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-arrow-left-right mr-4" viewBox="0 0 16 16">
                      ...
                      <span class="menu-title fs-5 ">Ventas</span>
                  </a>
              </li>
          </ul>
      </nav>
